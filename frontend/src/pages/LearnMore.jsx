    ...
    <div className="bg-[url('/public/pixel-bg.jpg')] h-full bg-cover flex flex-col items-center p-10 font-parkinsans">
      ...
      <div className="text-center mt-16">
        ...
        <div className="flex justify-center">
          {/* Sign Up Button */}
          <button 
            className="p-3 pl-7 pr-7 border-2 border-pink-700 rounded-md glass font-bold hover:bg-pink-700 hover:text-white transition duration-300 mx-3"
            onClick={() => {
              setUserAuth("register"); // Set auth state to 'register'
          ...
          <button 
            className="p-3 pl-7 pr-7 border-2 border-pink-700 rounded-md glass font-bold hover:bg-pink-700 hover:text-white transition duration-300 mx-3"
            onClick={() => {
              setUserAuth("login"); // Set auth state to 'login'
              navigate("/auth"); // Navigate to the auth page
            }}
          >
            Login
