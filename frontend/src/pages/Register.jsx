    ...
    <>
      <div className='bg-[url("public/pink-7761356_960_720.webp")] h-[100vh] bg-cover flex justify-center'>
        <div className='flex w-[100%] justify-center'>
          ...
          <div className='relative flex flex-col justify-center items-center top-[10%] bg-[url("public/ai-generated-8123097_640.webp")] h-[80vh] w-[30%] bg-contain bg-opacity-20 rounded-l-lg'>
          ...
          <div className='flex flex-col justify-center glasseffect w-[30%] h-[80vh] relative top-[10%] rounded-r-lg'>
            <div className='flex flex-col justify-center items-center font-bold text-xl'>
              <img src="public/pixelpals-high-resolution-logo-black-transparent.png" alt="App-logo" width="300px" height="300px" className='pb-8' />
